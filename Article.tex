...
As for the analytical models presented previously, Figure \ref{fig:iCorrelationANN} shows a comparison between the flow stresses predicted by the ANN model and the data measured during the hot compression test.
\begin{figure}[!ht]
\centering
