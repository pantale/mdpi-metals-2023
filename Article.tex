...
From the experimental data (stress-strain curves), 5 analytical models such as Johnson-Cook (JC), Modified Zerilli-Armstrong (MZA), Hansel-Spittel (HS), Arrhenius (AR) and PTM on the one hand, and an ANN model with 3 inputs, 2 hidden layers of 15 and 7 neurons respectively and 1 output, on the other hand, have been identified to predict the flow of this alloy. 
The comparison between the analytical models, the ANN model and the experimental results, carried out on the basis of the Mean Absolute Relative Error $\AARE$ and the Root Mean Square Error ($\RMSE$), allowed us to qualify the fidelity of these models.
